...
and also upgrading the translation system to capture PO files' full capability - plurals support, context support, and ability to include translator comments.
